...
Feature: Retskraft evaluation ordering under section 50
  # Module scope: opendebt-debt-service.section50 (FR-01..FR-10, NFR-01..NFR-03)
  ...
  Scenario: Identical input produces the same ordering without manual override
    Given debtor "D-06010" has these doubtful claims under collection:
      | claimId  | category            | suspectedDataError |
      | C-060101 | FINE                | false              |
      | C-060102 | PRIVATE_MAINTENANCE | false              |
      | C-060103 | OTHER               | false              |
    When the system generates the default retskraft evaluation worklist
