  ...
  void constructorsAndSettersWork() {
    ...
    DebtEntity copied =
        new DebtEntity(
            ...
            entity.getPrincipal(),
            entity.getCreditorReference(),
            entity.getClaimArt(),
            entity.getClaimCategory(),
            entity.getParentClaimId(),
            entity.getLimitationDate(),
            ...
            entity.getEstateProcessing(),
            entity.getJudgmentDate(),
            entity.getSettlementDate(),
            entity.getInterestSelection(),
            entity.getClaimNote(),
            entity.getCustomerNote(),
            entity.getPNumber(),
            // TB-040: PSRM dækningsrækkefølge fields (added in V3 migration)
            entity.getSekvensNummer(),
            entity.getGilParagraf(),
            entity.getBeloebOpkraevningsrenter(),
            entity.getBeloebInddrivelsesrenterFordringshaver(),
            entity.getBeloebInddrivelsesrenterFoerTilbagefoersel(),
            entity.getBeloebInddrivelsesrenterStk1(),
