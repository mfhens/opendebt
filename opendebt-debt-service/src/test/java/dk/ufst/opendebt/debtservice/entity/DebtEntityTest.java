  ...
  void constructorsAndSettersWork() {
    ...
    DebtEntity copied =
        new DebtEntity(
            ...
            entity.getHovedstol(),
            entity.getFordingshaverReference(),
            entity.getFordringsart(),
            entity.getFordringKategori(),
            entity.getHovedfordringsId(),
            entity.getForaeldelsesdato(),
            entity.getBeskrivelse(),
            entity.getPeriodeFra(),
            entity.getPeriodeTil(),
            entity.getStiftelsesdato(),
            entity.getForfaldsdato(),
            entity.getSidsteRettigeBetalingsdato(),
            entity.getBobehandling(),
            entity.getDomsdato(),
            entity.getForligsdato(),
            entity.getRentevalg(),
            entity.getFordringsnote(),
            entity.getKundenote(),
            entity.getPNummer(),
            entity.getLifecycleState(),
            entity.getModtagelsestidspunkt(),
            entity.getStatus(),
