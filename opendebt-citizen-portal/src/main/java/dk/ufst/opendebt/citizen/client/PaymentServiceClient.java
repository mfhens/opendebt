...
/**
 * BFF client for payment-service in the citizen portal. Provides debt event retrieval for the
 * citizen timeline. Ref: petition050 specs §4.3.
 */
@Slf4j
@Component
public class PaymentServiceClient {
  ...
  public List<DebtEventDto> getDebtEventsByCase(UUID caseId) {
    log.debug("Getting debt events for case (citizen timeline): {}", caseId);
